  ...
  return (
    <div className="min-h-screen font-sans text-gray-800 pb-20 print:pb-0 print:bg-white relative">
      ...
      >
        ...
        {/* 4. MAPA */}
        <section className="bg-white p-2 rounded-3xl shadow-xl shadow-emerald-900/5 border border-emerald-100 print:shadow-none print:border print:border-gray-300">
